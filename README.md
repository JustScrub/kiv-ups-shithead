...
```
cd existing_repo
git remote add origin https://gitlab.com/scrub2/kiv-ups-shithead.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/scrub2/kiv-ups-shithead/-/settings/integrations)
